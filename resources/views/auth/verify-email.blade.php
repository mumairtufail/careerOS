<x-guest-layout>
    <div class="text-center mb-6">
        <div class="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-warning-500 to-warning-600 rounded-xl flex items-center justify-center shadow-lg shadow-warning-500/30">
    ...
    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 p-3 bg-success-50 dark:bg-success-900/20 border border-success-200 dark:border-success-800 rounded-xl">
    ...
    <div class="space-y-4">
        ...
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" class="btn-ghost w-full py-2">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
