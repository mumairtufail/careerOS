<x-guest-layout>
    <div class="text-center mb-6">
        <div class="w-12 h-12 mx-auto mb-4 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center shadow-lg shadow-primary-500/30">
